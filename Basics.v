...
Definition invertBit (b : bit) : bit :=
  match b with
  | B0 => B1
  | B1 => B0
  end.

Definition invertNybble (nb : nybble) : nybble :=
  match nb with
  | bits b0 b1 b2 b3 => bits (invertBit b0) (invertBit b1) (invertBit b2) (invertBit b3)
  end.
Compute (invertNybble (bits B1 B0 B0 B1)).
...
Theorem inv_involutive : forall (b:bit), invertBit (invertBit b) = b.
Proof. intros b. destruct b.
 - simpl. reflexivity.
 - simpl. reflexivity.
Qed.
(* intros -> tira o forall *)
(* destruct -> mostrar todas as formas de b *)


Theorem invertNybbleInvolutive : forall (n:nybble) , invertNybble (invertNybble n) = n.
Proof. intros n. destruct n. simpl.
